...
Если новость НЕ имеет прямой связи с Россией, российской экономикой, российскими компаниями, российскими банками, российскими биржами, российским рынком капитала, санкциями, регулированием РФ, экспортом/импортом РФ, или событиями, которые могут повлиять на стоимость российских активов — 
то установи:
"skip": true
и в полях оцени как:
"tone": "neutral",
...
"impact_score": 0,
"relevance": "low",
"summary": "не относится к РФ",

Это правило ВСЕГДА имеет приоритет.
Если нет чёткой связи с РФ — skip = true.
